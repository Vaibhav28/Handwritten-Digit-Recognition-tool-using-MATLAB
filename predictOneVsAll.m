function [p,pval] = predictOneVsAll(all_theta, X)
...
% learned logistic regression parameters (one-vs-all).
%              setting p to a vector of predictions (from 1 to
%               num_labels).
%
...
z=X*all_theta';
% using sigmoid function to convert to p between 0 to 1
h=sigmoid(z);
